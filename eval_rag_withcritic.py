...
from eval_rag_withcritic_utils import (
    load_file,
    process_input_data,
    postprocess_output,
    test_kilt,
...
def main():
    ...
    parser.add_argument('--input_file', type=str,
                        default='./data/nq/test_0_w_passages_bge.jsonl')
    ...
    parser.add_argument('--task', type=str,
                        default='nq', help="which task will be used.")
    ...
    parser.add_argument('--output_path', type=str,
                        default="results/Llama3_8b_instruct_nq_ck_rag_withcritic/alpha1")
    parser.add_argument('--exp_name', type=str,
                        default="nq_ck_Llama3_8b_instruct_withcritic_alpha1")
    parser.add_argument('--case_num', type=int, default=-1)

    # NEW: whether to use GenPRM critic
    parser.add_argument('--use_critic', action='store_true',
                        help='Use GenPRM/GenPRM-1.5B critic to filter retrieved passages.')
    ...
    params_dict = {
        ...
        "logprobs": None,
        "mode": args.mode,
        # NOTE: this was hardcoded in your original code as 1.0.
        # If you want args.alpha instead, set "alpha": args.alpha.
        "alpha": args.alpha,
        "select_top": 10,
    ...
    # -------------------------
    # Load critic model (GenPRM)
    # -------------------------
    critic_model = None
    critic_tokenizer = None
    if args.use_critic:
        critic_model_name = "GenPRM/GenPRM-1.5B"
    ...
    # pass critic_model and critic_tokenizer into process_input_data
